...
Manage state using the browser’s local storage

Implement dark/light themes using JavaScript

Organize and structure SCSS files efficiently

Write cleaner and more reusable JavaScript code
...
Sync todos with a real backend
...
Thanks to Frontend Mentor
 for providing this challenge and design inspiration.
